...
function webteck_pagination( $args = array() ) {
    ...
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'webteck' ),
        'next_string'     => esc_html__( '&raquo;', 'webteck' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'webteck_pagination_defaults', $defaults )
    );
