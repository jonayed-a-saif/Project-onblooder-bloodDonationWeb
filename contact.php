            ...
            <div class="row">
                    ...
                    <div class="contact-wrapper-content section--bg2 h-100">
                        ...
                        <ul class="contact-info-list">
                            ...
                            <li class="single-info d-flex flex-wrap align-items-center">
                                ...
                                <div class="single-info__content">
                                    <p><a href=""><span class="__cf_email__" data-cfemail="84e0e1e9ebc4e3e9e5ede8aae7ebe9">info@onblooder.com</span></a></p>
                                </div> 
                            </li>
                ...
                <div class="col-lg-6">
                    <form method="POST" action="#" class="contact-form">
                        <input type="hidden" name="_token" value="w4ARB189GTNH3jYa3LYnfHGJlpmYmNe8zBKZ9Olh">                        <div class="row">
